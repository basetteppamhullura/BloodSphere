 ...
 */
export function checkDonorEligibility(donor) {
 ...
 */
export function calculateSmartDonorMatches(donors, targetBloodGroup, requesterLat, requesterLng, maxRadiusKm = 50, urgency = 'CRITICAL') {
