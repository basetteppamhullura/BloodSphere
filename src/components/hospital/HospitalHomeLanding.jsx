...
import { Building2, ShieldAlert, Activity, PlusCircle, ArrowRight, Droplet, UserPlus } from 'lucide-react';
export const HospitalHomeLanding = ({ onNavigateToTab }) => {
    ...
    return (<div className="space-y-6 text-xs animate-in fade-in w-full max-w-7xl mx-auto">
      ...
      {overdueCriticalReq && (<div className="p-4 rounded-2xl bg-red-50 border-2 border-red-200 text-red-900 flex items-center justify-between shadow-sm animate-pulse">
          ...
          <button onClick={() => onNavigateToTab('overview')} className="px-4 py-2 rounded-full bg-red-600 text-white font-black text-xs uppercase shadow-md hover:bg-red-500 flex items-center gap-1">
      ...
      <div className="space-y-3 pt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div onClick={() => onNavigateToTab('overview')} className="p-5 rounded-3xl bg-white border border-sky-100 hover:border-sky-300 cursor-pointer space-y-3 shadow-xs transition-all hover:scale-[1.02] group">
          ...
          <div onClick={() => onNavigateToTab('overview')} className="p-5 rounded-3xl bg-white border border-sky-100 hover:border-emerald-300 cursor-pointer space-y-3 shadow-xs transition-all hover:scale-[1.02] group">
          ...
          <div onClick={() => setActiveEmergencyPostModal(true)} className="p-5 rounded-3xl bg-white border border-sky-100 hover:border-amber-300 cursor-pointer space-y-3 shadow-xs transition-all hover:scale-[1.02] group">
