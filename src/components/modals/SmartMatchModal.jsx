...
import { Sparkles, X, Send, MapPin, Clock, Zap } from 'lucide-react';
      ...
      <div className="w-full max-w-2xl max-h-[85vh] bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="p-6 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="space-y-3">
            ...
            const isTier1 = idx < 2;
            return (<div key={donor.id} className="p-4 rounded-2xl bg-slate-800/40 border border-slate-800 flex items-center justify-between text-xs">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`px-2 py-0.5 rounded text-[9px] font-bold ${isTier1 ? 'bg-emerald-950 text-emerald-300 border border-emerald-800' : 'bg-slate-800 text-slate-400'}`}>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950 flex justify-end">
          <button onClick={handleSendPulse} disabled={pulseSent} className={`px-5 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 ${pulseSent ? 'bg-emerald-600 text-white' : 'bg-red-600 hover:bg-red-500 text-white shadow-lg shadow-red-950'}`}>
