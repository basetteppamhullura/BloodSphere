...
export const Footer = () => {
    return (<footer className="bg-gradient-to-b from-[#E0F2FE] via-[#F0F9FF] to-white border-t border-sky-200/90 text-[#0D2B45] text-xs mt-12 shadow-2xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="space-y-2">
            ...
            <a href="https://nbtc.naco.gov.in" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-[#0EA5E9] font-bold hover:underline text-[11px] mt-1">
