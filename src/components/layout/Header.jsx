...
export const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-40 bg-white/98 backdrop-blur-md border-b border-sky-100/90 shadow-2xs w-full max-w-full overflow-hidden">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                    ...
                    <div className="relative shrink-0" ref={portalRef}>
                        <button
                            ...
                            className="px-2.5 sm:px-3 py-1.5 rounded-full bg-[#F0F9FF] hover:bg-[#E0F2FE] text-[#0369A1] border border-[#BAE6FD] font-bold text-xs flex items-center gap-1 transition-all cursor-pointer shadow-2xs"
                            aria-expanded={isPortalDropdownOpen}
                            aria-haspopup="true"
                            title="View accessible portals"
                        >
                            <LayoutGrid className="w-3.5 h-3.5 text-[#0284C7] shrink-0" />
                            <span className="hidden md:inline whitespace-nowrap">Portal Access</span>
                        ...
                        {isPortalDropdownOpen && (
                            <div className="absolute right-0 mt-2 w-64 sm:w-72 rounded-2xl bg-white border border-sky-100 shadow-xl p-2.5 z-50 space-y-1.5 text-xs animate-in fade-in slide-in-from-top-2 duration-150">
                    ...
                    {currentUser ? (
                        <div className="relative shrink-0" ref={profileRef}>
                            <button
                                ...
                                className="flex items-center gap-2 p-1 sm:px-2 sm:py-1 rounded-full hover:bg-slate-100/80 border border-slate-200/80 transition-all cursor-pointer shadow-2xs max-w-[170px]"
                            ...
                            {isProfileDropdownOpen && (
                                <div className="absolute right-0 mt-2 w-60 sm:w-64 rounded-2xl bg-white border border-sky-100 shadow-xl p-2.5 z-50 space-y-2 text-xs animate-in fade-in slide-in-from-top-2 duration-150">
