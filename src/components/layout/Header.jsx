...
export const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-40 bg-white/98 backdrop-blur-md border-b border-sky-100/90 shadow-2xs w-full max-w-full relative overflow-visible">
            ...
            {/* Main Header Container - 3 Section Flex Layout: Left (Logo), Center (Nav), Right (Actions) */}
            <div className="w-full max-w-full px-3 sm:px-4 lg:px-6 h-16 sm:h-18 flex items-center justify-between gap-2 lg:gap-4 relative z-10 box-border">
                ...
                {/* ================================================== */}
                {/* 2. CENTER SECTION — NAVIGATION (Flexible & Centered) */}
                {/* ================================================== */}
                ...
                {/* ================================================== */}
                {/* 3. RIGHT SECTION — ACTION CONTAINER               */}
                {/* ================================================== */}
                <div className="action-container flex items-center gap-1.5 sm:gap-2 shrink-0">
                    ...
                    >
                        ...
                        <span className="hidden sm:inline whitespace-nowrap">
                            <span className="hidden xl:inline">Post </span>Emergency<span className="hidden 2xl:inline"> Need</span>
                        </span>
                    ...
                    <div className="relative shrink-0" ref={portalRef}>
                        ...
                        >
                            ...
                            <span className="hidden md:inline whitespace-nowrap font-bold">Portal<span className="hidden 2xl:inline"> Access</span></span>
                    ...
                    {currentUser ? (
                        <div className="relative shrink-0" ref={profileRef}>
                            ...
                            >
                                ...
                                {/* User Details (Name & Role Badge with truncation) */}
                                <div className="hidden sm:flex flex-col text-left min-w-0 flex-1 overflow-hidden">
                                    <span className="font-bold text-xs text-slate-900 truncate leading-tight whitespace-nowrap overflow-hidden text-ellipsis">
                                        {currentUser.name}
                                    </span>
                                    <span className="text-[9px] font-extrabold uppercase text-sky-700 tracking-wider truncate whitespace-nowrap overflow-hidden text-ellipsis">
                                        {formatRoleName(currentRole)}
                                    </span>
                                </div>
