...
export const CardSkeleton = () => {
    return (<div className="p-5 rounded-2xl bg-slate-800/40 border border-slate-700/50 animate-pulse space-y-4">
...
export const TableSkeleton = () => {
    return (<div className="space-y-3 animate-pulse">
      {[1, 2, 3, 4, 5].map((i) => (<div key={i} className="h-12 w-full bg-slate-800/40 rounded-xl flex items-center justify-between px-4">
