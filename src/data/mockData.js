export const MOCK_PATIENT_VERIFICATIONS = [
    {
        id: 'pv_001',
...
export const MOCK_NOTIFICATIONS = [
    {
        ...
        message: "O- PRBC • 4 Units required urgently for Trauma Surgery patient at KIMS Teaching Hospital.",
        time: "2 minutes ago",
        createdAt: new Date(Date.now() - 2 * 60 * 1000).toISOString(),
        read: false,
        category: "Emergency",
        priority: "CRITICAL",
        requestId: "BR-REQ-1025",
        bloodGroup: "O-",
        component: "PRBC",
        units: 4,
        source: "KIMS Teaching Hospital",
        urgency: "CRITICAL"
    },
    {
        id: "notif_req_106",
        title: "New blood request received",
        message: "Direct Requester submitted request for 2 units O+ PRBC for Rohan Kumar.",
        time: "15 minutes ago",
        ...
        component: "PRBC",
        units: 2,
        source: "Direct Requester System",
        urgency: "HIGH"
    },
    {
        id: "notif_inv_301",
        title: "Inventory updated",
        message: "O+ PRBC stock increased by 4 units from voluntary donation drive. Current available: 28 units.",
        time: "32 minutes ago",
    ...
    {
        id: "notif_low_501",
        title: "O- PRBC inventory is below configured minimum level",
        message: "O- PRBC available stock: 3 units. Configured safety threshold: 5 units.",
        time: "1 hour ago",
        ...
        component: "PRBC",
        units: 3,
        source: "Regional Supply Monitor"
    },
    {
        id: "notif_exp_601",
        title: "Unit BU-2026-000125 approaching expiry",
        message: "Unit BU-2026-000125 (O+ PRBC) in Fridge A-01 expires within 48 hours. Prioritize FEFO dispatch.",
        time: "2 hours ago",
        ...
        component: "PRBC",
        units: 1,
        source: "Cold Vault Telemetry"
    },
    {
        id: "notif_exp_602",
        title: "Unit U-2026-8802 expired and quarantined",
        message: "Unit U-2026-8802 (O- Whole Blood) reached expiration date. Status updated to EXPIRED according to inventory lifecycle.",
        time: "4 hours ago",
    ...
    {
        id: "notif_hosp_701",
        title: "KIMS Teaching Hospital confirmed receipt",
        message: "KIMS Teaching Hospital confirmed physical receipt of 2 units O- PRBC for Request req_101.",
        time: "5 hours ago",
    ...
    },
    {
        ...
        message: "Voluntary donor Dr. Ananya Sharma agreed to donate O- blood for Request req_101. Private chat active.",
        time: "6 hours ago",
    ...
    {
        id: "notif_bb_901",
        title: "Blood transfer request TRF-9021 approved",
        message: "Rotary Regional Blood Center Dharwad approved inter-city replenishment transfer of 2 units AB- Platelets.",
        time: "8 hours ago",
        ...
        units: 2,
        source: "Dharwad Regional Center"
    },
    {
        id: "notif_sys_1001",
        title: "Cold chain telemetry scan completed",
        message: "Automated scan verified all 4 vault sensor nodes operating within optimal temperature ranges (2.0°C - 6.0°C).",
        time: "12 hours ago",
    ...
    {
        id: "notif_sec_1101",
        title: "Regional staff session authenticated",
        message: "Verified login for Blood Bank Staff from IP 15.3647, 75.124. Audit trace logged.",
        time: "1 day ago",
        createdAt: new Date(Date.now() - 24 * 3600 * 1000).toISOString(),
        read: true,
        category: "Security",
        priority: "LOW",
        source: "Auth Governance System"
    }
];
