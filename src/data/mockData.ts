...
export const MOCK_EMERGENCY_REQUESTS: EmergencyRequest[] = [
  {
    ...
    status: "PENDING_HOSPITAL_APPROVAL", // Step 1
    aiUrgencyScore: 98,
    decayScore: 96,
    trendingReason: "Awaiting Hospital Verification • ICU Trauma Case",
    sharesCount: 12,
  ...
  },
  {
    ...
    status: "APPROVED", // Step 2 -> Step 3 searching donors
    aiUrgencyScore: 92,
    decayScore: 88,
    trendingReason: "Hospital Verified • 4 Donors Auto-Matched",
    sharesCount: 29,
  ...
  },
  {
    ...
    status: "DONOR_CONFIRMED", // Step 5
    assignedDonorId: "usr_donor_001",
    assignedDonorName: "Dr. Ananya Sharma",
    aiUrgencyScore: 82,
    decayScore: 80,
    trendingReason: "Donor Accepted • Hospital Scheduling Pending",
    sharesCount: 18,
  ...
  },
  {
    ...
    status: "APPOINTMENT_SCHEDULED", // Step 6
