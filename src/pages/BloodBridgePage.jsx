...
export const BloodBridgePage = () => {
    ...
    return (<div className="space-y-6 animate-in fade-in">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          {interCityTransfers.map((item) => (<div key={item.id} className="p-6 rounded-3xl bg-slate-900 border border-slate-800 space-y-4">
              ...
              <div className="flex justify-between items-center pt-2">
                ...
                <button onClick={() => showToast(`Initiated Inter-City Cold Chain Transport for ${item.units} units of ${item.bloodGroup}!`)} className="px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-md flex items-center gap-1.5">
