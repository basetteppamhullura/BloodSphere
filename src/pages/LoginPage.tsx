      ...
      <div className="w-full max-w-4xl space-y-8 relative z-10 animate-in fade-in duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
          ...
          >
            <div className="flex items-center justify-between">
              <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-lg font-black ${
                activePortalTab === 'donor' ? 'bg-white/20 text-white' : 'bg-red-100 text-red-600'
              }`}>
                ❤️
              </div>
              {activePortalTab === 'donor' && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-lg font-black ${
                activePortalTab === 'requester' ? 'bg-white/20 text-white' : 'bg-rose-100 text-rose-600'
              }`}>
                🆘
              </div>
              {activePortalTab === 'requester' && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-lg font-black ${
                activePortalTab === 'hospital' ? 'bg-white/20 text-white' : 'bg-sky-100 text-sky-600'
              }`}>
                🏥
              </div>
              {activePortalTab === 'hospital' && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-lg font-black ${
                activePortalTab === 'admin' ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-800'
              }`}>
                🛡️
              </div>
              {activePortalTab === 'admin' && (
        ...
        <div className="max-w-xl mx-auto p-8 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-6 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <div className="flex items-center gap-2.5">
              <span className={`w-9 h-9 rounded-2xl flex items-center justify-center text-base font-bold ${
                activePortalTab === 'donor'
