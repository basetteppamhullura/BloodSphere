...
export const RareRegistryPage = () => {
    ...
    const [isRegistered, setIsRegistered] = useState(loggedInDonor.isRareGroup ?? isRareGroup);
    ...
    return (<div className="space-y-6 text-xs animate-in fade-in">
      ...
      <div className="p-6 rounded-3xl bg-white border border-sky-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button onClick={handleToggleRareRegistration} className={`px-5 py-2.5 rounded-2xl font-extrabold text-xs shadow-md flex items-center justify-center gap-2 transition-all ${isRegistered
      ...
      <div className="p-6 rounded-3xl bg-white border border-sky-100 space-y-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {rareDonors.map((donor) => {
            ...
            return (<div key={donor.id} className="p-5 rounded-3xl bg-white border border-sky-100 space-y-4 hover:border-sky-300 transition-all shadow-xs flex flex-col justify-between">
                <div>
                ...
                <button onClick={() => setActiveChatModal({ request: requests[0], donor })} className="w-full py-2.5 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-900 font-extrabold text-xs border border-sky-200 flex items-center justify-center gap-2 transition-all">
