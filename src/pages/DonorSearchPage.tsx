      ...
      <div className="p-5 rounded-3xl bg-white border border-sky-100 shadow-sm grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2.5 rounded-xl bg-slate-50 border border-slate-200 font-bold text-slate-900 focus:outline-none focus:border-sky-500"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredDonors.map((donor) => {
          ...
          return (
            <div
              key={donor.id}
              className="p-5 rounded-3xl bg-white border border-sky-100 space-y-4 hover:border-sky-300 transition-all flex flex-col justify-between shadow-xs"
            >
              <div>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className={`px-2.5 py-1 rounded-full text-[10px] font-black ${
                    isAvail ? 'bg-emerald-100 text-emerald-800 border border-emerald-200' : 'bg-slate-100 text-slate-500'
                  }`}>
              ...
              <button
                ...
                className="w-full mt-2 py-2.5 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-900 font-extrabold text-xs border border-sky-200 flex items-center justify-center gap-2 transition-all"
              >
