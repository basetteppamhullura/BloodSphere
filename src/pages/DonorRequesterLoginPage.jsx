...
export const DonorRequesterLoginPage = () => {
    const { login } = useAuth();
    ...
    return (<div className="max-w-md mx-auto my-8 space-y-6 animate-in fade-in">
      ...
      <div className="p-8 rounded-3xl bg-white border border-sky-100 shadow-lg space-y-5">
        ...
        {loginError && (<div className="p-3 rounded-2xl bg-red-50 border border-red-200 text-red-700 text-xs font-bold flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} className="w-full p-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 font-bold text-xs focus:outline-none focus:border-sky-500" required/>
          </div>
