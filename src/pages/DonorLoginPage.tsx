...
export const DonorLoginPage: React.FC = () => {
        ...
        <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <button
              ...
              className={`w-full py-4 rounded-2xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 text-white font-extrabold text-xs shadow-lg shadow-red-500/20 flex items-center justify-center gap-2 transition-all cursor-pointer ${
